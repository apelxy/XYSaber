...
/**
 *	Usually XYMASConstraintMaker but could be a parent MASConstraint
 */
...
@interface XYMASConstraint (Abstract)
 ...
 *  A MASViewConstraint may turn into a XYMASCompositeConstraint when an array is passed to one of the equality blocks
 */
